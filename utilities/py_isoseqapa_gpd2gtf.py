...
def convert_gpd2gtf(input_gpd,output_gtf):
	for line in input_gpd:
		...
		grouped_polya_site,polya_site_count = line.strip().split("\t")[-2:]
		info_transcript = 'gene_id "' + gene_id + '"; transcript_id "' + isoform_id + '"; full_length_LR_count "' + full_length_LR_count + '"; LR_count "' + LR_count + '"; derived_genic_loci "' + derived_genic_loci + '"; derived_genic_loci_overlap_pct "' + derived_genic_loci_overlap_pct + '"; sgt_last_exon_iso "' + sgt_last_exon_iso + '"; sgt_last_exon_overlap_pct "' + sgt_last_exon_overlap_pct + '"; mlt_splice_site "' + mlt_splice_site + '"; mlt_subset_iso "' + mlt_subset_iso + '"; polya_len "' + polya_len + '"; polya_pct "' + polya_pct + '"; grouped_polya_site "' + grouped_polya_site + '"; polya_site_count "' + polya_site_count + '";'
